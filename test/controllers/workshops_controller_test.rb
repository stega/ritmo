...
class WorkshopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post workshops_url, params: { workshop: { description: @workshop.description, name: @workshop.name, time: @workshop.time, zoom_link: @workshop.zoom_link } }
    end
  ...
  test "should update workshop" do
    patch workshop_url(@workshop), params: { workshop: { description: @workshop.description, name: @workshop.name, time: @workshop.time, zoom_link: @workshop.zoom_link } }
